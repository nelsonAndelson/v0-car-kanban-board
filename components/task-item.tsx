  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className={cn("font-medium truncate", task.is_completed && "line-through")}>{task.title}</div>
        {task.description && <div className="text-muted-foreground truncate">{task.description}</div>}
      </div>
